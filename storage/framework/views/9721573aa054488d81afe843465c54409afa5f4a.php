        ...
        <div class="container">
            <div class="grid gap-10 lg:grid-cols-3">
                <div class="lg:col-span-2">
                    ...
                    <div class="mb-8">
                        <form id="review-form" action="<?php echo e(route('front.reviews.store')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                                    ...
                                    <template x-if="value < 5" class="flex items-center">
                                        <template x-for="i in (5 - value)">
                                            <svg class="w-10 h-10 text-accent" @click="value=value+i">
                                                <use xlink:href="<?php echo e(asset('assets/front/img/sprite.svg')); ?>#staro" />
                                            </svg>
                                        </template>
                                    </template>
                            ...
                            <div class="mb-4 form-group">
                                <div id="review-g-recaptcha" data-sitekey="<?php echo e(config('constants.google_recaptcha')); ?>" data-callback="onSubmitReview" data-size="invisible">
                                </div>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        var enquiry_validator = $("#enquiry-form").validate({
            ...
            submitHandler: function(form, event) {
                event.preventDefault();
                $(form).find('#redirect-url').val('<?php echo route('front.reviews.index'); ?>');
...
<?php echo $__env->make('layouts.front_inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tlanders/public_html/resources/views/front/reviews/create.blade.php ENDPATH**/ ?>