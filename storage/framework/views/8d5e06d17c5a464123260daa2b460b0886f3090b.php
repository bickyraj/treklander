        ...
        <div class="col">
            ...
            <div class="kt-portlet">
                <form class="kt-form" id="add-form-page" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?php echo e($why_choose->id); ?>">
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-form__actions mt-3">
                            <a href="<?php echo e(route('admin.why-chooses.index')); ?>" class="btn btn-sm btn-secondary">Cancel</a>
                ...
                <!--begin::Form-->
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group">
                            <label>Title</label>
                            <input type="text" value="<?php echo e($why_choose->title); ?>" name="title" class="form-control" placeholder="" required>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="row">
                              <div class="col-lg-7">
                                <div class="mb-3">
                                    <img id="cropper-image" class="crop-img-div" src="<?php echo e($why_choose->image_url); ?>">
                                </div>
                              </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="" cols="30" rows="10" class="form-control" required><?php echo e($why_choose->description); ?></textarea>
                        </div>
                    </div>
...
$(function() {
  ...
  function handleRegionForm(form) {
    ...
    $.ajax({
        url: "<?php echo e(route('admin.why-chooses.update')); ?>",
        type: 'POST',
        data: formData,
        dataType: 'json',
        processData: false,
        ...
        success: function(res) {
            if (res.status === 1) {
                location.href = '<?php echo e(route('admin.why-chooses.index')); ?>';
            }
        }
    });
  }
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tlanders/public_html/resources/views/admin/whyChooses/edit.blade.php ENDPATH**/ ?>