                ...
                <div class="grid lg:grid-cols-5 gap-2">
                    <div class="col-lg-2 col-md-2 col-sm-2">
                        <div class="form-group">
                            ...
                            <input type="text" id="keyword" class="form-control" value="<?php echo e($get_keyword ?? ''); ?>"
                                name="keyword" />
                        </div>
                    </div>
                    <div class="col-lg-4">
                                ...
                                <?php if($destinations): ?>
                                    <?php $__currentLoopData = $destinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $destination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($destination->id); ?>"
                                            <?php echo e(isset($get_destination_id) && $get_destination_id == $destination->id ? 'selected' : ''); ?>>
                                ...
                                <?php if($activities): ?>
                                    <?php $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($activity->id); ?>"
                                            <?php echo e(isset($get_activity_id) && $get_activity_id == $activity->id ? 'selected' : ''); ?>>
        ...
        $(function() {
            ...
            async function paginate(page) {
                return new Promise((resolve, reject) => {
                    ...
                    $.ajax({
                        ...
                        $("#spinner-block").html('');
                        $("#show-more").show();
                        window.history.pushState({}, "", "<?php echo route('front.trips.listing'); ?>?" +
                        url_query);
                        resolve(true);
                    });
                });
            ...
            function filter() {
                ...
                xhr = $.ajax({
                    ...
                    window.history.pushState({}, "", "<?php echo route('front.trips.listing'); ?>?" + url_query);
                });
            }
        });
    </script>
...
<?php echo $__env->make('layouts.front_inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tlanders/public_html/resources/views/front/trips/listing.blade.php ENDPATH**/ ?>