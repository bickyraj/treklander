                          ...
                          <div class="form-group">
                              <div class="form-group">
                                ...
                                <div class="kt-checkbox-list">
                                  <?php if(iterator_count($destinations)): ?>
                              ...
                              <div class="form-group">
                                ...
                                <div class="kt-checkbox-list">
                                  <?php if(iterator_count($activities)): ?>
                                    ...
                                    <label class="kt-checkbox kt-checkbox--brand">
                                      <input type="checkbox" name="activities[]" value="<?php echo e($activity->id); ?>"> <?php echo e($activity->name); ?>
...
$(function() {
    ...
    function handlePageAddForm(form) {
      ...
      $.ajax({
          url: "<?php echo e(route('admin.regions.store')); ?>",
          type: 'POST',
          data: formData,
          dataType: 'json',
          processData: false,
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\laravelapps\laravel5\treklander\resources\views/admin/regions/add.blade.php ENDPATH**/ ?>