        ...
        <div class="col">
            ...
            <div class="kt-portlet">
                <form class="kt-form" id="add-form-page" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?php echo e($trip_review->id); ?>">
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-form__actions mt-3">
                            <a href="<?php echo e(route('admin.trip-reviews.index')); ?>" class="btn btn-sm btn-secondary">Cancel</a>
                ...
                <!--begin::Form-->
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group">
                            <label>Title</label>
                            <input type="text" value="<?php echo e($trip_review->title); ?>" name="title" class="form-control" placeholder="" required>
                        </div>
                        <div class="form-group">
                          ...
                          <select class="custom-select form-control form-control-sm" name="trip_id">
                              ...
                              <option value="<?php echo e($trip->id); ?>" <?php echo (($trip_review->trip_id == $trip->id)?'selected':'');?>><?php echo e($trip->name); ?></option>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </select>
                        </div>
                        <div class="form-group">
                            <label>Reviewer Name</label>
                            <input type="text" value="<?php echo e($trip_review->review_name); ?>" name="review_name" class="form-control" placeholder="" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                              <div class="col-lg-7">
                                <div class="mb-3">
                                    <img id="cropper-image" class="crop-img-div" src="<?php echo e($trip_review->image_url); ?>">
                                </div>
                        ...
                        <div class="form-group">
                            <label>Review</label>
                            <textarea name="review" id="" cols="30" rows="10" class="form-control"><?php echo e($trip_review->review); ?></textarea>
                        </div>
                        <div class="form-group">
                          <label class="form-label">Rating</label>
                          <div>
                            <input type="hidden" id="trip-rating" name="rating" class="rating" value="<?php echo e($trip_review->rating); ?>" data-filled="fas fa-star fa-2x" data-empty="far fa-star fa-2x"/>
                          </div>
                        </div>
                    </div>
...
$(function() {
  ...
  function handleRegionForm(form) {
    ...
    $.ajax({
        url: "<?php echo e(route('admin.trip-reviews.update')); ?>",
        type: 'POST',
        data: formData,
        dataType: 'json',
        processData: false,
        ...
        success: function(res) {
            if (res.status === 1) {
                location.href = '<?php echo e(route('admin.trip-reviews.index')); ?>';
            }
        }
    });
  }
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tlanders/public_html/resources/views/admin/tripReviews/edit.blade.php ENDPATH**/ ?>