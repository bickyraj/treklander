    ...
    <div class="container">
        <div class="grid lg:grid-cols-3 xl:grid-cols-4 gap-10">
            <div class="lg:col-span-2 xl:col-span-3">
                <div class="mb-8">
                    <form id="payment_form" action="<?php echo e(route('front.store_payment_from_footer')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" required name="trip_name" value="<?php echo e(session('trip_name')??""); ?>" class="form-control" id="trip" placeholder="Trip Name">
                        </div>
                        <div class="form-group mb-4">
...
<?php echo $__env->make('layouts.front_inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\laravelapps\laravel5\treklander\resources\views/front/payment/payment.blade.php ENDPATH**/ ?>