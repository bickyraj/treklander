            ...
            <div class="col">
                ...
                <div class="kt-portlet">
                    <form class="kt-form" id="add-form-page" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo e($destination->id); ?>">
                            ...
                            <div class="tab-content trip-tab-form">
                                ...
                                <div class="tab-pane active" id="kt_tabs_1_1" role="tabpanel">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-7">
                                                <div class="mb-3">
                                                    <img id="cropper-image" class="crop-img-div" src="<?php echo e($destination->image_url); ?>">
                                                </div>
                                    ...
                                    <div class="form-group">
                                        <label>Title</label>
                                        <input type="text" value="<?php echo e($destination->name); ?>" name="name" class="form-control" aria-describedby="emailHelp" placeholder="Title" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php if(!empty($destination->tour_guide_image_name)): ?>
                                            ...
                                            <div id="tour-guide-image-name-block">
                                                <p><span id="tour-guide-image-name"><?php echo e($destination->tour_guide_image_name); ?></span><button id="remove-tour-guide-image-name-file-btn"
                                ...
                                <div class="tab-pane" data-index="2" id="kt_tabs_1_2" role="tabpanel">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <textarea name="seo[meta_title]" class="form-control form-control-sm" id="" cols="30" rows="2"><?php echo e($destination->seo->meta_title ?? ''); ?></textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <textarea name="seo[meta_keywords]" class="form-control form-control-sm" id="" cols="30" rows="2"><?php echo e($destination->seo->meta_keywords ?? ''); ?></textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="text" id="input-trip-name" value="<?php echo e($destination->seo->canonical_url ?? ''); ?>" class="form-control form-control-sm"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <textarea name="seo[meta_description]" class="form-control form-control-sm" id="" cols="30" rows="2"><?php echo e($destination->seo->meta_description ?? ''); ?></textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <div>
                                                <p id="social_image_name"><?php echo e($destination->seo->social_image ?? ''); ?></p>
                                            </div>
                                            <div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            function handleDestinationForm(form) {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.destinations.update')); ?>",
                    type: 'POST',
                    data: formData,
                    dataType: 'json',
                    processData: false,
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tlanders/public_html/resources/views/admin/destinations/edit.blade.php ENDPATH**/ ?>