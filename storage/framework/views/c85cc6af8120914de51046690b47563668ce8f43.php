                            ...
                            <div class="tab-content trip-tab-form">
                                                ...
                                                <?php if($destinations): ?>
                                                    <?php $__currentLoopData = $destinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <label class="kt-checkbox kt-checkbox--brand">
                                                            <input type="checkbox" name="destinations[]" value="<?php echo e($country->id); ?>"> <?php echo e($country->name); ?>
                                ...
                                <div class="tab-pane" data-index="2" id="kt_tabs_1_2" role="tabpanel">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="text" id="input-trip-name" value="<?php echo e($destination->seo->canonical_url ?? ''); ?>" class="form-control form-control-sm" name="seo[canonical_url]">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            function handlePageAddForm(form) {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.activities.store')); ?>",
                    type: 'POST',
                    data: formData,
                    dataType: 'json',
                    processData: false,
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\laravelapps\laravel5\treklander\resources\views/admin/activities/add.blade.php ENDPATH**/ ?>