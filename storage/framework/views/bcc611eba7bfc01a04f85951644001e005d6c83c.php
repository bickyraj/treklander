        ...
        <div class="col">
            ...
            <div class="kt-portlet">
                <form class="kt-form" id="add-form-page" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?php echo e($region->id); ?>">
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-form__actions mt-3">
                            <a href="<?php echo e(route('admin.regions.index')); ?>" class="btn btn-sm btn-secondary">Cancel</a>
                      ...
                      <div class="tab-content trip-tab-form">
                        ...
                        <div class="tab-pane active" id="kt_tabs_1_1" role="tabpanel">
                          <div class="form-group">
                              ...
                              <div class="row">
                                <div class="col-lg-7">
                                  <div class="mb-3">
                                      <img id="cropper-image" class="crop-img-div" src="<?php echo e($region->image_url); ?>">
                                  </div>
                          ...
                          <div class="form-group">
                              <label>Title</label>
                              <input type="text" value="<?php echo e($region->name); ?>" name="name" class="form-control" aria-describedby="emailHelp" placeholder="Title" required>
                          </div>
                          <div class="form-group">
                              <div class="form-group">
                                <label >Country</label>
                                <div class="kt-checkbox-list">
                                  <?php if($destinations): ?>
                                    ...
                                    <label class="kt-checkbox kt-checkbox--brand">
                                      <input type="checkbox" name="destinations[]" value="<?php echo e($country->id); ?>" 
                                      <?php echo ((in_array($country->id, $destination_ids)?'checked': '')); ?>> <?php echo e($country->name); ?>
                              ...
                              <div class="form-group">
                                ...
                                <div class="kt-checkbox-list">
                                  <?php if($activities): ?>
                                    ...
                                    <label class="kt-checkbox kt-checkbox--brand">
                                      <input type="checkbox" name="activities[]" value="<?php echo e($activity->id); ?>" 
                                      <?php echo ((in_array($activity->id, $activity_ids)?'checked': '')); ?>> <?php echo e($activity->name); ?>
                        ...
                        <div class="tab-pane" data-index="2" id="kt_tabs_1_2" role="tabpanel">
                          <div class="form-group row">
                            ...
                            <div class="col-lg-7">
                              <textarea name="seo[meta_title]" class="form-control form-control-sm" id="" cols="30" rows="2"><?php echo e($region->seo->meta_title ?? ''); ?></textarea>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-lg-7">
                              <textarea name="seo[meta_keywords]" class="form-control form-control-sm" id="" cols="30" rows="2"><?php echo e($region->seo->meta_keywords ?? ''); ?></textarea>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-lg-7">
                              <input type="text" id="input-trip-name" value="<?php echo e($region->seo->canonical_url ?? ''); ?>" class="form-control form-control-sm" name="seo[canonical_url]">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-lg-7">
                              <textarea name="seo[meta_description]" class="form-control form-control-sm" id="" cols="30" rows="2"><?php echo e($region->seo->meta_description ?? ''); ?></textarea>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-lg-7">
                              <div>
                                <p id="social_image_name"><?php echo e($region->seo->social_image ?? ''); ?></p>
                              </div>
                              <div>
...
$(function() {
  ...
  function handleRegionForm(form) {
    ...
    $.ajax({
        url: "<?php echo e(route('admin.regions.update')); ?>",
        type: 'POST',
        data: formData,
        dataType: 'json',
        processData: false,
        ...
        success: function(res) {
            if (res.status === 1) {
                ...
                location.href = '<?php echo e(route('admin.regions.index')); ?>';
                // form[0].reset();
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tlanders/public_html/resources/views/admin/regions/edit.blade.php ENDPATH**/ ?>