                ...
                <form class="kt-form" id="add-form-team" enctype="multipart/form-data">
                    ...
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-form__actions mt-3">
                            <a href="<?php echo e(route('admin.teams.index')); ?>" class="btn btn-sm btn-secondary">Cancel</a>
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group">
                            ...
                            <div class="row">
                              <div class="col-lg-7">
                                <div class="mb-3">
                                  <img id="cropper-image" class="crop-img-div" src="<?php echo e($team->image_url); ?>">
                                </div>
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" value="<?php echo e($team->name); ?>" name="name" class="form-control" aria-describedby="" placeholder="Name" required>
                        </div>
                        <div class="form-group">
                            <label>Type</label>
                            <select name="type" id="" class="form-control form-control-sm">
                              <option value="1" <?php echo e((($team->type == 1)?"selected":"")); ?>>Administration</option>
                              <option value="2" <?php echo e((($team->type == 2)?"selected":"")); ?>>Representatives</option>
                              <option value="3" <?php echo e((($team->type == 3)?"selected":"")); ?>>Tour Guides</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>Position</label>
                            <input type="text" value="<?php echo e($team->position); ?>" name="position" class="form-control" aria-describedby="" placeholder="Position" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col">
                                ...
                                <div class="row">
                                    <ul id="multiple-file">
                                        <?php $__currentLoopData = $team->certificates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $certificate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li data-key="<?php echo e($certificate->id); ?>"><?php echo e($certificate->file); ?> <i class='fas fa-times remove-file'></i></li>
                            ...
                            <div class="col">
                                ...
                                <div class="row">
                                    <ul id="multiple-picture">
                                        <?php $__currentLoopData = $team->galleries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gallery): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li data-key="<?php echo e($gallery->id); ?>"><?php echo e($gallery->file); ?> <i class='fas fa-times remove-picture'></i></li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                </div>
                            </div>
...
<script src="<?php echo e(asset('assets/vendors/file-upload/js/jquery.ui.widget.js')); ?>"></script>
<script src="<?php echo e(asset('assets/vendors/file-upload/js/jquery.iframe-transport.js')); ?>"></script>
<script src="<?php echo e(asset('assets/vendors/file-upload/js/jquery.fileupload.js')); ?>"></script>
...
$(function() {
  ...
  function handleTeamForm(form) {
    ...
    $.ajax({
        url: "<?php echo e(route('admin.teams.update')); ?>",
        type: 'POST',
        data: formData,
        dataType: 'json',
        processData: false,
        ...
        success: function(res) {
            if (res.status === 1) {
                location.href = '<?php echo e(route('admin.teams.index')); ?>';
            }
        }
    });
  }
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tlanders/public_html/resources/views/admin/teams/edit.blade.php ENDPATH**/ ?>