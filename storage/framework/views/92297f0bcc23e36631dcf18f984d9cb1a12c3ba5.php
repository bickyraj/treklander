...
<section class="hero hero-alt relative">
    <img src="<?php echo e(asset('assets/front/img/activities.webp')); ?>" alt="">
...
//     const debounceTime = 500;
    let totalPage = "<?php echo e($activities->total()); ?>";
    let nextPage = "<?php echo e($activities->nextPageUrl()); ?>"
    let currentPage = "<?php echo e($activities->currentPage()); ?>";
//     $('html, body').animate({
...
function performSearch() {
  ...
  $("#show-more").on('click', async function(event) {
    ...
    async function paginate(page) {
        return new Promise((resolve, reject) => {
            const url = "<?php echo route('front.activities.index'); ?>" + "?page=" + page;
            $.ajax({
                url: url,
                type: "GET",
                dataType: "json",
  ...
  function filter() {
    ...
    var filter_url = '<?php echo e(route("front.activities.search")); ?>' + '?' + url_query;
    // window.location.href = filter_url;
    const url = "<?php echo route('front.activities.search'); ?>" + "?" + url_query;
        xhr = $.ajax({
            url: url,
            type: "GET",
            dataType: "json",
...
<?php echo $__env->make('layouts.front_inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tlanders/public_html/resources/views/front/activities/index.blade.php ENDPATH**/ ?>