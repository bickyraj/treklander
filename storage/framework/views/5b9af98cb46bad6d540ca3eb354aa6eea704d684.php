                ...
                <form class="kt-form" id="add-form-page" enctype="multipart/form-data">
                    ...
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-form__actions mt-3">
                            <a href="<?php echo e(route('admin.trips.edit', $slider->trip_id)); ?>" class="btn btn-sm btn-secondary">Cancel</a>
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group">
                            ...
                            <div class="row">
                              <div class="col-lg-7">
                                <div class="mb-3">
                                    <img id="cropper-image" class="crop-img-div" src="<?php echo e($slider->image_url); ?>">
                                </div>
                        ...
                        <div class="form-group">
                            <label>ALT Tag</label>
                            <input type="text" value="<?php echo e($slider->alt_tag); ?>" name="alt_tag" class="form-control" placeholder="">
                        </div>
                        <div class="form-group">
                            <label>Caption</label>
                            <input type="text" value="<?php echo e($slider->caption); ?>" name="caption" class="form-control" placeholder="">
                        </div>
                    </div>
...
$(function() {
  ...
  function handleBannerForm(form) {
    ...
    $.ajax({
        url: "<?php echo e(route('admin.trips.galleries.update')); ?>",
        type: 'POST',
        data: formData,
        dataType: 'json',
        processData: false,
        ...
        success: function(res) {
            if (res.status === 1) {
                let url = `<?php echo e(route('admin.trips.edit', ':TRIP_ID')); ?>`;
                const sliderId = '<?php echo e($slider->trip_id); ?>';
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tlanders/public_html/resources/views/admin/trips/edit-slider.blade.php ENDPATH**/ ?>