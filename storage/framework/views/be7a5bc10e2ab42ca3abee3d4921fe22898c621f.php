                    ...
                    <div class="tab-content trip-tab-form">
                        <div class="tab-pane active" id="kt_tabs_1_1" role="tabpanel">
                          ...
                          <div class="form-group">
                            ...
                            <div class="kt-checkbox-list">
                              <?php if(iterator_count($trips)): ?>
                                ...
                                <label class="kt-checkbox kt-checkbox--brand">
                                  <input type="checkbox" name="similar_trips[]" value="<?php echo e($trip->id); ?>"> <?php echo e($trip->name); ?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="kt-checkbox-list">
                              <?php if(iterator_count($trips)): ?>
                                <?php $__currentLoopData = $trips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="kt-checkbox kt-checkbox--brand">
                                  <input type="checkbox" name="addon_trips[]" value="<?php echo e($trip->id); ?>"> <?php echo e($trip->name); ?>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-lg-7">
                                <textarea class="form-control form-control-sm" name="iframe" id="" cols="30" rows="10"></textarea>
                            </div>
                          </div>
                          <hr>
                          <div class="form-group row">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\laravelapps\laravel5\treklander\resources\views/admin/trips/add.blade.php ENDPATH**/ ?>