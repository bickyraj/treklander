                    ...
                    <form class="kt-form" id="add-form-page" enctype="multipart/form-data">
                        ...
                        <div class="kt-portlet__head">
                            ...
                            <div class="mt-3 kt-form__actions">
                                <a href="<?php echo e(route('admin.activities.index')); ?>" class="btn btn-sm btn-secondary">Cancel</a>
                            ...
                            <div class="tab-content trip-tab-form">
                                ...
                                <div class="tab-pane active" id="kt_tabs_1_1" role="tabpanel">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-7">
                                                <div class="mb-3">
                                                    <img id="cropper-image" class="crop-img-div" src="<?php echo e($activity->image_url); ?>">
                                                </div>
                                    ...
                                    <div class="form-group">
                                        <label>Title</label>
                                        <input type="text" value="<?php echo e($activity->name); ?>" name="name" class="form-control" aria-describedby="emailHelp" placeholder="Title" required>
                                    </div>
                                    <div class="form-group">
                                        <div class="form-group">
                                            <label>Country</label>
                                                ...
                                                <?php if($destinations): ?>
                                                    <?php $__currentLoopData = $destinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <label class="kt-checkbox kt-checkbox--brand">
                                                            <input type="checkbox" name="destinations[]" value="<?php echo e($country->id); ?>" <?php echo in_array($country->id, $destination_ids) ? 'checked' : ''; ?>> <?php echo e($country->name); ?>
                                ...
                                <div class="tab-pane" data-index="2" id="kt_tabs_1_2" role="tabpanel">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <textarea name="seo[meta_title]" class="form-control form-control-sm" id="" cols="30" rows="2"><?php echo e($activity->seo->meta_title ?? ''); ?></textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <textarea name="seo[meta_keywords]" class="form-control form-control-sm" id="" cols="30" rows="2"><?php echo e($activity->seo->meta_keywords ?? ''); ?></textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <input type="text" id="input-trip-name" value="<?php echo e($activity->seo->canonical_url ?? ''); ?>" class="form-control form-control-sm" name="seo[canonical_url]">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <textarea name="seo[meta_description]" class="form-control form-control-sm" id="" cols="30" rows="2"><?php echo e($activity->seo->meta_description ?? ''); ?></textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <div>
                                                <p id="social_image_name"><?php echo e($activity->seo->social_image ?? ''); ?></p>
                                            </div>
                                            <div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            function handleActivityForm(form) {
                ...
                $.ajax({
                    url: "<?php echo e(route('admin.activities.update')); ?>",
                    type: 'POST',
                    data: formData,
                    dataType: 'json',
                    processData: false,
                    ...
                    success: function(res) {
                        if (res.status === 1) {
                            ...
                            location.href = '<?php echo e(route('admin.activities.index')); ?>';
                            // form[0].reset();
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tlanders/public_html/resources/views/admin/activities/edit.blade.php ENDPATH**/ ?>