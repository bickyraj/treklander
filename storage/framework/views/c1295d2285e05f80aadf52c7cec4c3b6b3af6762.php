        ...
        <div class="container">
            <div class="grid gap-20 lg:grid-cols-3">
                <div class="lg:col-span-2">
                    <form id="captcha-form" action="<?php echo e(route('front.trips.booking.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.front_inner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tlanders/public_html/resources/views/front/trips/booking.blade.php ENDPATH**/ ?>