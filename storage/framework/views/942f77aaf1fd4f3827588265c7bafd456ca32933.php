                ...
                <!--begin::Form-->
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="review_name" class="form-control" placeholder="" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div>
                            <input type="hidden" id="trip-rating" name="rating" class="rating" data-filled="fas fa-star fa-2x" data-empty="far fa-star fa-2x"/>
                          </div>
                        </div>
                    </div>
...
$(function() {
  $("#trip-rating").rating();
    ...
    function handleReviewAddForm(form) {
      ...
      $.ajax({
          url: "<?php echo e(route('admin.trip-reviews.store')); ?>",
          type: 'POST',
          data: formData,
          dataType: 'json',
          processData: false,
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tlanders/public_html/resources/views/admin/tripReviews/add.blade.php ENDPATH**/ ?>