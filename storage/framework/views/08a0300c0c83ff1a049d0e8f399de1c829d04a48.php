...
<?php $__env->startSection('content'); ?>
    ...
    <script>
        const price_ranges = <?php echo json_encode($price_ranges, 15, 512) ?>;
    ...
    <section class="py-20" x-data="{ noOfTravellers: 1, rate: <?php echo e(isset($trip->offer_price) && !empty($trip->offer_price) ? $trip->offer_price : $trip->cost); ?>, paymentType: 'half', price_ranges: <?php echo e(json_encode($price_ranges)); ?>,
