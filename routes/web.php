...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['web', 'admin']], function () {
	...
	Route::post('trips/price-range/update', 'TripController@updateTripPriceRange')->name('trips.pricerange.update');
...
Route::post('/payment', 'Front\PaymentController@storePayment')->name('front.store_payment');
Route::post('/custom-payment', 'Front\PaymentController@storePaymentFromFooter')->name('front.store_payment_from_footer');
Route::post('/payment/callback', 'Front\PaymentController@callbackPayment')->name('front.home.payment.callback');
Route::get('/redeem-payment/{id}', 'Front\PaymentController@redeemPayment')->name('front.redeem_payment');
Route::post('/trips/filter/{region?}/{destination_id?}/{activity_id?}/{srotBy?}', 'Front\TripController@filter')->name('front.trips.filter');

Route::get('/hbl', 'Front\PaymentController@index')->name('hbl.index');
Route::post('/hbl/payment-request', 'Front\PaymentController@paymentRequest')->name('hbl.paymentrequest');
Route::get('/hbl/payment/success', 'Front\PaymentController@paymentSuccess')->name('hbl.payment.success');
Route::get('/hbl/payment/canceled', 'Front\PaymentController@paymentCanceled')->name('hbl.payment.canceled');
Route::get('/hbl/payment/failed', 'Front\PaymentController@paymentFailed')->name('hbl.payment.failed');

Route::get('/make-a-payment', 'Front\PaymentController@makePayment')->name('front.makeapayment');
...
Route::get('/destinations/trips', 'Front\DestinationController@getTrips')->name('front.destinations.gettrips');
