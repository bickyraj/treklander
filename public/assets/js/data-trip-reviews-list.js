			...
			columns: [
				...
				},
				{
                    ...
                    template: function(item) {
                        return (item.review).substring(0, 100) + '...';
                    }
				},
				{
					field: 'status',
				...
				},
				{
					...
					template: function(item) {
						return '\
						<a href="'+url+'/admin/trip-reviews/edit/'+item.id+'" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit details">\
