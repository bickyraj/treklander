                            ...
                            <div class="tab-pane active" data-index="1" id="kt_tabs_1_1" role="tabpanel">
                                <form class="kt-form" id="edit-trip-form" enctype="multipart/form-data">
                                        ...
                                        <div class="col-lg-7">
                                            <select class="custom-select form-control form-control-sm" name="destination_id">
                                                ...
                                                @foreach ($destinations as $country)
                                                    <option value="{{ $country->id }}" <?= $trip->destination && $trip->destination->id == $country->id ? 'selected' : '' ?>>{{ $country->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <div>
                                                <p><span id="map_file_name">{!! $trip->map_original_file_name ? $trip->map_original_file_name : 'choose file' !!}</span><button id="remove-map-file-btn" class="btn btn-sm text-danger"><i
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-7">
                                            <div>
                                                ...
                                                <p><span id="pdf_file_name">{!! $trip->pdf_original_file_name ? $trip->pdf_original_file_name : 'choose file' !!}</span><button id="remove-pdf-file-btn" class="btn btn-sm text-danger"><i
                                                            class="fa fa-times"></i></button></p>
                                            </div>
                                            <div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-3">
                                            <input type="hidden" id="trip-rating" name="rating" value="{{ $trip->rating }}" class="rating" data-filled="fas fa-star fa-2x"
