                                    ...
                                    <div class="dd nestable2" id="nestable2">
                                        <ol class="{{ (iterator_count($menu_items))?'dd-list': 'dd-empty' }}">
                                            @if($menu_items)
                                                ...
                                                <li class="dd-item" data-link="{{ $menu->link }}" data-type="{{ $menu->type }}" data-name="{{ $menu->name }}" data-mega-menu="{{ $menu->mega_menu }}" data-id="<?php echo (($menu->menu_itemable_type == null)?1:$menu->menu_itemable_id);?>">
                                                    <div class="dd-handle">{{ $menu->name }}</div>
                                                    <div>
                                                        <div class="checkbox-inline" style="position: absolute; top: 0px; right: 12px; padding-top: 6px;">
                                                            <label class="checkbox checkbox-success" style="color:white;">
                                                            <input class="mega-menu-checkbox" {{ ($menu->mega_menu == 1 ? 'checked':'') }} type="checkbox">
                                                            <span></span>Mega Menu</label>
                                                        </div>
                                                    </div>
                                                    @if($menu->children)
