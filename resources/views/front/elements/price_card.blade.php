<div x-data="{isGroupDiscountsShown: {{ $isGroupDiscountsShown == false ? 'false' : 'true' }}}" class="pt-4 mb-6 rounded-lg price-card bg-primary">
    ...
    <div class="p-4 text-white">
        @if ($trip->cost)
            ...
            <div class="mb-2 font-display">
                ...
                <span class="text-5xl font-bold text-accent">{{ number_format($trip->offer_price) }}</span>
        ...
        <div class="">
            <a href="{{ route('front.trips.print', ['slug' => $trip->slug]) }}" class="flex items-center text-white" title="Print tour details">
