...
<div class="pt-10 bg-gray">
    ...
    <img src="{{ asset('assets/front/img/webpage_art.webp') }}" width="1920" height="275" alt="Art representing various natural and cultutal heritages of Nepal"
   ...
   {{--
    ...
    <div class="bottom">
        <div class="container">
            ...
            <div class="mb-2 affiliations">
                <ul>
                    {{-- <p class="p-2 mr-1"><a href="#"><img class="lazyload" data-src="{{ asset('assets/front/img/certified1.png') }}" alt="Travel Life"></a></p> --}}
                </ul>
            </div>
            ...
            <div class="mb-2 affiliations">
                ...
                <ul class="flex gap-2">
                    <li class="p-2 mr-1"><a href="#"><img loading="lazy" src="{{ asset('assets/front/img/ng.svg') }}" alt="Nepal Government Ministry of Culture, Tourism & Civil Aviation"
                                class="object-contain w-16 h-16" width="179" height="150"></a></li>
                    <li class="p-2 mr-1"><a href="#"><img loading="lazy" src="{{ asset('assets/front/img/ntb.svg') }}" alt="Nepal Tourism Board" class="object-contain w-16 h-16" width="148"
                                height="150"></a></li>
                    <li class="p-2 mr-1"><a href="#"><img loading="lazy" src="{{ asset('assets/front/img/taan.svg') }}" class="object-contain w-16 h-16"
                                alt="Trekking Agencies' Association of Nepal" width="112" height="150"></a></li>
                    <li class="p-2"><a href="#"><img loading="lazy" src="{{ asset('assets/front/img/nma.svg') }}" class="object-contain w-16 h-16"
                                alt="Nepal Mountaineering Association" width="180" height="150"></a>
                    </li>
                     <li class="p-2"><a href="https://www.tripadvisor.com/Attraction_Review-g293890-d25277337-Reviews-Treklanders_Adventures-Kathmandu_Kathmandu_Valley_Bagmati_Zone_Central_Region.html" target="_blank"><img loading="lazy" src="{{ asset('assets/front/img/ta.jpg') }}" class="object-contain w-16 h-16"
    ...
    <div class="pb-20 text-xs text-center bg-primary">
        <div class="container justify-between md:flex">
            <div class="mb-2">
                All Contents &copy; {{ date('Y') }}. All right Reserved.
            </div>
            ...
            <div class="payments">
                <img src="{{ asset('assets/front/img/payment.svg') }}" alt="we accept mastercard, visa, and american express" loading="lazy">
            </div>
        </div>
    </div>
</footer><!-- Footer -->
